...
<nav id="n">
  ...
  <div id='socialbuttons'>
    ...
    <a href="http://twitter.com/afrendeiro" title="Follow me on Twitter" alt="Twitter Icon" target="_blank"><img class="social" src="<?php bloginfo('template_directory');?>/img/32x32/twitter-32.png"></a>
    <a href="http://gplus.to/andrerendeiro" title="Add me on Google+" alt="Google Plus Icon" target="_blank"><img class="social" src="<?php bloginfo('template_directory');?>/img/32x32/googleplus-32.png"></a>
    <a href="http://github.com/afrendeiro" title="Fork me on Github" alt="Github Icon" target="_blank"><img class="social" src="<?php bloginfo('template_directory');?>/img/32x32/github-32.png"></a>
    <script type="text/javascript" src="<?php bloginfo('template_directory');?>/js/obfuscate-email_nav.js" language="javascript"></script>
    <a href="<?php bloginfo('rss2_url'); ?>" title="Subscribe to my RSS feed" alt="RSS Icon" target="_blank"><img class="social" src="<?php bloginfo('template_directory');?>/img/32x32/rss-32.png"></a>
  </div>
